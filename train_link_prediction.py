...
from models.MemoryModel_Pool import MemoryModel_Pool
from models.TGAT import TGAT
from models.TGAT_Pool import TGAT_Pool
from models.TGAT_Pool import TGAT_Pool as TGAT_MM
# from models.TGAT_MM import TGAT_MM
from models.MemoryModel import MemoryModel, compute_src_dst_node_time_shifts
from models.CAWN import CAWN
from models.CAWN_Pool import CAWN_Pool
from models.CAWN_Pool import CAWN_Pool as CAWN_MM
# from models.CAWN_MM import CAWN_MM
from models.TCL import TCL
from models.TCL_Pool import TCL_Pool
from models.GraphMixer import GraphMixer
from models.GraphMixer_Pool import GraphMixer_Pool
from models.DyGFormer import DyGFormer
from models.DyGFormer_pool import DyGFormer_Pool
from models.DyGFormer_pool import DyGFormer_Pool as DyGFormer_MM
# from models.DyGFormer_MM import DyGFormer_MM
from models.PoolMixer import PoolMixer
...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        if args.model_name == 'TGAT':
            ...
            dynamic_backbone = MemoryModel(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler, pool_kernel_size = args.pool_kernel_size,
            ...
            src_node_mean_time_shift, src_node_std_time_shift, dst_node_mean_time_shift_dst, dst_node_std_time_shift = \
                compute_src_dst_node_time_shifts(train_data.src_node_ids, train_data.dst_node_ids, train_data.node_interact_times)
            dynamic_backbone = MemoryModel_Pool(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler, pool_kernel_size = args.pool_kernel_size,
                                           time_feat_dim=args.time_feat_dim, model_name=args.model_name, num_layers=args.num_layers, num_heads=args.num_heads,
                                           dropout=args.dropout, src_node_mean_time_shift=src_node_mean_time_shift, src_node_std_time_shift=src_node_std_time_shift,
            ...
            dynamic_backbone = DyGFormer_Pool(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler, pool_kernel_size=args.pool_kernel_size,
                                         time_feat_dim=args.time_feat_dim, channel_embedding_dim=args.channel_embedding_dim, patch_size=args.patch_size,
                                         num_layers=args.num_layers, num_heads=args.num_heads, dropout=args.dropout,
                                         max_input_sequence_length=args.max_input_sequence_length, device=args.device)
        elif args.model_name == 'CAWN_Pool':
            dynamic_backbone = CAWN_Pool(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features,
            ...
            dynamic_backbone = DyGFormer_MM(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler,
                                         time_feat_dim=args.time_feat_dim, channel_embedding_dim=args.channel_embedding_dim, patch_size=args.patch_size,
                                         num_layers=args.num_layers, num_heads=args.num_heads, dropout=args.dropout,
                                         max_input_sequence_length=args.max_input_sequence_length, device=args.device)
        elif args.model_name == 'CAWN_MM':
            dynamic_backbone = CAWN_MM(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler,
                                    time_feat_dim=args.time_feat_dim, position_feat_dim=args.position_feat_dim, walk_length=args.walk_length,
                                    num_walk_heads=args.num_walk_heads, dropout=args.dropout, device=args.device, num_neighbors = args.num_neighbors)
        elif args.model_name == 'TGAT_MM':
            dynamic_backbone = TGAT_MM(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler, num_neighbors=args.num_neighbors,
                                    time_feat_dim=args.time_feat_dim, num_layers=args.num_layers, num_heads=args.num_heads, dropout=args.dropout, device=args.device)
        elif args.model_name == 'PoolMixer':
            dynamic_backbone = PoolMixer(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler,
                                         time_feat_dim=args.time_feat_dim, channel_embedding_dim=args.channel_embedding_dim, patch_size=args.patch_size,
                                         num_layers=args.num_layers, num_heads=args.num_heads, dropout=args.dropout, channel_kernel_size=args.pool_kernel_size,token_kernel_size=args.pool_kernel_size,
                                         max_input_sequence_length=args.max_input_sequence_length, device=args.device)
        else:
        ...
        save_model_folder = f"./saved_models/{args.model_name}_{args.identify}/{args.dataset_name}/{args.save_model_name}/"
        ...
        for epoch in range(args.num_epochs):
            ...
            if args.model_name in ['DyRep', 'TGAT', 'TGN', 'CAWN', 'TCL', 'GraphMixer', 'DyGFormer',
                                   'DyGFormer_Pool','CAWN_Pool', 'TGAT_Pool', 'DyRep_Pool', 'TGN_Pool','TCL_Pool', 'GraphMixer_Pool'
                                   'DyGFormer_MM', 'CAWN_MM', 'TGAT_MM', 'PoolMixer']:
                # training, only use training graph
                model[0].set_neighbor_sampler(train_neighbor_sampler)
            if args.model_name in ['JODIE', 'DyRep', 'TGN', 'DyRep_Pool', 'TGN_Pool']:
            ...
            for batch_idx, train_data_indices in enumerate(train_idx_data_loader_tqdm):
                ...
                if args.model_name in ['TGAT', 'CAWN', 'TCL','CAWN_Pool', 'TGAT_Pool','TCL_Pool', 'CAWN_MM', 'TGAT_MM']:
                    ...
                    batch_neg_src_node_embeddings, batch_neg_dst_node_embeddings = \
                        model[0].compute_src_dst_node_temporal_embeddings(src_node_ids=batch_neg_src_node_ids,
                                                                          ...
                                                                          node_interact_times=batch_node_interact_times,
                                                                          num_neighbors=args.num_neighbors)
                elif args.model_name in ['JODIE', 'DyRep', 'TGN', 'DyRep_Pool', 'TGN_Pool']:
                    ...
                    batch_src_node_embeddings, batch_dst_node_embeddings = \
                        model[0].compute_src_dst_node_temporal_embeddings(src_node_ids=batch_src_node_ids,
                                                                          ...
                                                                          num_neighbors=args.num_neighbors)
                elif args.model_name in ['GraphMixer','GraphMixer_Pool']:
                    # get temporal embedding of source and destination nodes
                    # two Tensors, with shape (batch_size, node_feat_dim)
                    batch_src_node_embeddings, batch_dst_node_embeddings = \
                        model[0].compute_src_dst_node_temporal_embeddings(src_node_ids=batch_src_node_ids,
                    ...
                    batch_neg_src_node_embeddings, batch_neg_dst_node_embeddings = \
                        model[0].compute_src_dst_node_temporal_embeddings(src_node_ids=batch_neg_src_node_ids,
                                                                          ...
                                                                          num_neighbors=args.num_neighbors,
                                                                          time_gap=args.time_gap)
                elif args.model_name in ['DyGFormer', 'DyGFormer_Pool', 'DyGFormer_MM', 'PoolMixer']:
                    # get temporal embedding of source and destination nodes
                    # two Tensors, with shape (batch_size, node_feat_dim)
                    batch_src_node_embeddings, batch_dst_node_embeddings = \
                        model[0].compute_src_dst_node_temporal_embeddings(src_node_ids=batch_src_node_ids,
        ...
        if args.model_name not in ['JODIE', 'DyRep', 'TGN', 'DyRep_Pool', 'TGN_Pool']:
            val_losses, val_metrics = evaluate_model_link_prediction(model_name=args.model_name,
                                                                     model=model,
                                                                     neighbor_sampler=full_neighbor_sampler,
                                                                     evaluate_idx_data_loader=val_idx_data_loader,
